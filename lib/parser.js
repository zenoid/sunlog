...
var getWeatherData = function () {
  ...
  var getWeatherDay = function( dayNum ) {
    ...
    request.get({
      ...
      locations[ timestamp ].sunrise = w.sunriseTime? w.sunriseTime : null;
      locations[ timestamp ].sunset = w.sunsetTime? w.sunsetTime : null;
      locations[ timestamp ].min = w.apparentTemperatureMin? +w.apparentTemperatureMin.toFixed( 1 ) : null;
      locations[ timestamp ].max = w.apparentTemperatureMax? +w.apparentTemperatureMax.toFixed( 1 ) : null;
      locations[ timestamp ].clouds = w.cloudCover? w.cloudCover :  null;
